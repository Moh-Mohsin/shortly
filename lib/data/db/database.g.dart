    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `ShortUrl` (`code` TEXT NOT NULL, `fullShortLink` TEXT NOT NULL, `originalLink` TEXT NOT NULL, `timestamp` INTEGER NOT NULL, PRIMARY KEY (`code`))');
...
class _$ShortUrlDao extends ShortUrlDao {
  ...
  Stream<List<ShortUrl>> findAllShortUrls() {
    return _queryAdapter.queryListStream(
        ...
        mapper: (Map<String, Object?> row) => ShortUrl(
            row['code'] as String,
